...
2. Two or more Watcher scripts (e.g., Gmail \+ Bank transactions)
...
3. Multiple MCP servers for different action types

4. Weekly Business Audit with CEO Briefing generation

5. Error recovery and graceful degradation

6. Comprehensive audit logging

7. Documentation of your architecture and lessons learned
...
* **The Muscle (Claude Code):** Runs in your terminal, pointed at your Obsidian vault. It uses its **File System tools** to read your tasks and write reports.
...
* **Logic Engine:** Claude Code (running claude-3-5-sonnet or any other LLM using Claude Code Router).  
...
8. Minimize data collection: Only capture what's necessary

9. Local-first: Keep sensitive data on your machine when possible

10. Encryption at rest: Consider encrypting your Obsidian vault

11. Third-party caution: Understand what data leaves your system via APIs
